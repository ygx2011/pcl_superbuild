...
set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -std=gnu99 -U__STRICT_ANSI__ -Wno-everything")
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -std=c++11 -stdlib=libc++ -miphoneos-version-min=5.0 -U__STRICT_ANSI__ -Wno-everything")
...
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -O0 -Wreturn-type")
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -fexceptions -fasm-blocks")
